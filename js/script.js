    ...
    try {
        if (name == "" || surname == "" || lastname == "" || email == "" || password == "") {
            ...
            if (response.data) {
                ...
                setTimeout(function () { window.location.href = "https://jesuscab77.github.io/"; }, 200);
            } else {
                swal({
                    title: "Error!",
                    text: JSON.stringify(response.message),
...
let redirectLikeRole = async () =>{
    ...
    if (response.data.role_id === 2) {
        setTimeout(function () { window.location.href = "https://jesuscab77.github.io/pages/edificio.html"; }, 200)
    } else {
        //aquí va la vista del admin
        setTimeout(function () { window.location.href = "https://jesuscab77.github.io/pages/admin/admindashboard.html"; }, 200);      
    }
}
